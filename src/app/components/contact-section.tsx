        ...
        <div>
          <div>
            <h1 className="font-bold text-1xl text-white">
              ...
              ideas. If you&apos;re looking for someone who is passionate,
              creative, and ready to make a significant contribution, let&apos;s
              talk! Currently, I am actively seeking full-time job opportunities
              that will allow me to grow with and provide the best value to your
              team.
            </h1>
          </div>
          <div></div>
